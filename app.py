...
def submit(assignment_id):
    ...
    if request.method == 'POST':
        ...
        if file:
            ...
            # Scoped to the same assignment only
            ...
            if existing_duplicate:
                ...
                # 3. Vector Similarity Check — SCOPED TO THIS ASSIGNMENT ONLY
                # Only compare against other students' submissions for the same assignment
            ...
            if max_score > 0.45:  # 45% threshold — calibrated for handwriting OCR noise
